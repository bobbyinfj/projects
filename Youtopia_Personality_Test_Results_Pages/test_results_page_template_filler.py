f"""<div class="top-row" style="background-color: {background_color}; ">
<h2>You are a {tribe} ({mbti})!</h2>
[mks_col]
[mks_one_third]
...
<input name="group[22277]" type="hidden" value="32768"><!--ESTJ=1,ISTJ=2,ESFJ=4,ISFJ=8,ESTP=16,ISTP=32,ESFP=64,ISFP=128,ENFJ=256,INFJ=512,ENFP=1024,INFP=2048,ENTJ=4096,INTJ=8192,ENTP=16384,INTP=32768-->
